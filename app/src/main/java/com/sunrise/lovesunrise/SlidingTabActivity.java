...
import com.flyco.tablayout.DYSlidingTabLayout;
import com.flyco.tablayout.SlidingTabLayout;
import com.flyco.tablayout.listener.OnTabSelectListener;
import com.flyco.tablayout.widget.MsgView;
import com.sunrise.lovesunrise.util.ViewFindUtils;
...
public class SlidingTabActivity extends AppCompatActivity implements OnTabSelectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** 自定义 */
        DYSlidingTabLayout tabLayout_11 = ViewFindUtils.find(decorView, R.id.tl_11);
