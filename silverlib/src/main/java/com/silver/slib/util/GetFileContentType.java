...
/**
 * 
 * @ClassName: EnumGetFileContentType
 * @Description:
 * @author dongen_wang@163.com
 * @date 2015年3月11日 下午5:53:21
 *
 */
public class GetFileContentType {
	enum EnumGetFileContentType {
		...
		private EnumGetFileContentType(String type) {
			this.type = type;
		}
	...
	public static String getFileContentType(String filename) {
		...
		try {
			...
			result = EnumGetFileContentType.valueOf(suffix).toString();
		} catch (Exception e) {
